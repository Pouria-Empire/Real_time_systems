...
def draw_plots(result_dict):
    ...
    draw_execution_time(tasks_list, execution_times_cooperative_list, execution_times_best_list, execution_times_profile_list, number_tasks)

def draw_execution_time(tasks_list, execution_times_cooperative_list, execution_times_best_list, execution_times_profile_list, number_tasks):
